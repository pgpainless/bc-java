...
public class HardwareSecretKeyTest extends AbstractPgpKeyPairTest {
    @Override
    ...
    private void parseHardwareKey() throws IOException, PGPException {
        ...
        isEquals(armored, bOut.toString());
    }
