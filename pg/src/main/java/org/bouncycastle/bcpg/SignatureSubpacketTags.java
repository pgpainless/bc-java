...
public interface SignatureSubpacketTags 
{
    ...
    int LIBREPGP_ATTESTED_CERTIFICATIONS = 37;   // attested certifications (RESERVED)
    int LIBREPGP_KEY_BLOCK = 38;            // Key Block (RESERVED)
    int PREFERRED_AEAD_ALGORITHMS = 39;   // preferred AEAD algorithms
    int LIBREPGP_LITERAL_DATA_META_HASH = 40; // LibrePGP style metadata hashing
    int LIBREPGP_TRUST_ALIAS = 41;
}
