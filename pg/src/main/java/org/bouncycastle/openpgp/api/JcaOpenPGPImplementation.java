        ...
        extends OpenPGPImplementation
{
    ...
    {
        JcePBEKeyEncryptionMethodGenerator g = new JcePBEKeyEncryptionMethodGenerator(passphrase);
        g.setProvider(provider);
        g.setSecureRandom(secureRandom);
        return g;
    }
    ...
    {
        JcePBEKeyEncryptionMethodGenerator g = new JcePBEKeyEncryptionMethodGenerator(passphrase, argon2Params);
        g.setProvider(provider);
        g.setSecureRandom(secureRandom);
        return g;
    }
    ...
    public PGPContentSignerBuilder pgpContentSignerBuilder(int algorithm, int hashAlgorithm) {
        JcaPGPContentSignerBuilder b = new JcaPGPContentSignerBuilder(algorithm, hashAlgorithm);
        b.setProvider(provider);
